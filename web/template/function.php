...
<ol class="breadcrumb">
    ...
    <li><a href="<?= $BaseURL . $CurrentOpenFile; ?>/__functions">Functions</a></li>
    <li class="active"><?= htmlspecialchars($PageFunction['Function']); ?></li>

    <li class="pull-right"><a href="<?= $BaseURL . $CurrentOpenFile; ?>/__raw">File</a></li>
    <li class="pull-right"><a href="<?= $BaseURL . $CurrentOpenFile; ?>">Constants</a></li>
</ol>

<h1 class="page-header"><?= htmlspecialchars($PageFunction['Function']); ?></h1>

<h4 class="sub-header2">Syntax</h4>
<pre class="syntax"><?= htmlspecialchars($PageFunction['FullFunction']); ?></pre>
...
<pre class="description"><?= htmlspecialchars($PageFunction['Comment']); ?></pre>
